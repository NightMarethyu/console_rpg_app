    ...
    public Character CreateCharacter(CharacterBuilder builder, CharacterType type)
    {
        ...
        switch (type)
        {
            case CharacterType.Enemy:
                temp =  new Enemy(builder._id, builder._name, builder._currentHP, builder._maxHP, builder._isAlive, builder._strength, builder._dexterity, builder._wisdom, builder._armorValue, builder._attackValue, builder._tags);
                builder.Reset();
                return temp;
